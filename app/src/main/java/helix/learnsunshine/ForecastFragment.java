...
//            super.onCreateView(inflater, container, savedInstanceState);
    ...
    public class FitchWeatherTask extends AsyncTask<String, Void, String[]> {

        private String LOG_TAG = FitchWeatherTask.class.getSimpleName();
        private static final String KeyAPI = "cc3113ac6110b1e89e8e5716c2a07e18";
       ...
       */
        ...
        private String[] getWeatherDataFromJson(String forecastJsonStr, int numDays)
            ...
            for (int i = 0; i < resultStrs.length; i++) {
                Log.v(LOG_TAG, "Forecast entry: " + resultStrs[i]);
            }
            return resultStrs;
